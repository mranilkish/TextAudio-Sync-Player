 ...
 * @(#) MP3InfoPanel.java
 *
 * Created on 26.12.2013 by Anil Kishan
 * 
 *-----------------------------------------------------------------------
...
import sm.smcreator.smc.multimedia.mp3.id3.NullsoftID3GenreTable;
...
public class MP3InfoPanel extends JPanel
{
	...
	private JComboBox v2_Genre = null;
	...
	private javax.swing.JComboBox getV1_Genre()
	{
		if (v1_Genre==null)
		{
	...
	private javax.swing.JComboBox getV2_Genre()
	{
		if (v2_Genre==null)
		{
