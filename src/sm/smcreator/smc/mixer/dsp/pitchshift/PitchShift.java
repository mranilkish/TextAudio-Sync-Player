...
import sm.smcreator.smc.mixer.dsp.DSPEffekt;
import sm.smcreator.smc.mixer.dsp.FFT2;
import sm.smcreator.smc.system.FastMath;
...
public class PitchShift implements DSPEffekt
{
	 ...
	 * @see sm.smcreator.smc.mixer.dsp.DSPEffekt#initialize(javax.sound.sampled.AudioFormat, int)
	 */
	...
	/**
	 * @param active
	 * @see sm.smcreator.smc.mixer.dsp.DSPEffekt#setIsActive(boolean)
	 */
	...
	/**
	 * @return
	 * @see sm.smcreator.smc.mixer.dsp.DSPEffekt#isActive()
	 */
	 ...
	 * @param start
	 * @param length
	 * @see sm.smcreator.smc.mixer.dsp.DSPEffekt#doEffekt(float[], int, int)
	 */
